...
export default function SellPage() {
  ...
  return (
    <div className="min-h-screen bg-hh-canvas">
      ...
      <main>
        {/* Marketing hero — from main branch */}
        <section className="relative overflow-hidden border-b border-hh-border">
        ...
        {/* Seller dashboard sections — from my theme commit */}
        <div className="mx-auto max-w-[1080px] px-4 py-6 sm:px-5 lg:px-6">
        ...
        {/* Feature cards — from main branch */}
        <section className="mx-auto grid max-w-[1080px] gap-4 px-4 py-6 sm:px-5 md:grid-cols-3 lg:px-6">
          {[
            ...
            >
              ...
              <h2 className="mt-4 text-lg font-black text-hh-heading">
                {title}
              </h2>
              <p className="mt-2 text-sm leading-6 text-hh-muted">{text}</p>
            </article>
          ))}
        </section>
      </main>
