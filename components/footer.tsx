...
export default function Footer({ variant = "default" }: FooterProps) {
  return (
    <footer className="border-t border-[#d8dfdc] bg-[#f0f3ef]">
      {variant === "default" && (
        <div className="mx-auto grid max-w-[1180px] gap-4 border-b border-[#d8dfdc] px-4 py-6 sm:grid-cols-3 sm:px-6 lg:px-8">
          {[
            {
              icon: Leaf,
      ...
      <div className="mx-auto grid max-w-[1180px] gap-10 px-4 py-10 sm:px-6 md:grid-cols-[1.2fr_2fr] lg:px-8">
        <div>
          <Link
            href="/"
                ...
                {links.map((link) => (
                  <li key={link}>
                    <Link
                      ...
                      className="text-sm text-[#53615c] transition hover:text-[#063f34]"
                    >
                      {link}
                    </Link>
                  </li>
      ...
      <div className="border-t border-[#d8dfdc]">
        <div className="mx-auto flex max-w-[1180px] flex-col gap-3 px-4 py-5 text-sm text-[#53615c] sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
