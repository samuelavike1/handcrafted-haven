      ...
      <main>
        <section className="mx-auto grid max-w-[1180px] gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="mt-3 text-3xl font-black tracking-tight text-[#063f34] sm:text-4xl">
              The people behind the pieces.
            </h1>
            <p className="mt-4 max-w-xl text-base leading-7 text-[#53615c]">
        ...
        <section className="border-t border-[#d8dfdc] bg-[#f0f3ef] py-12">
