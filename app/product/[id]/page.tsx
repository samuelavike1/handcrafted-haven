  ...
  return (
    <div className="min-h-screen bg-[#fbfbf8]">
      ...
      <main className="mx-auto max-w-[1180px] px-4 py-8 sm:px-6 lg:px-8">
        <nav className="mb-6 text-sm font-semibold text-[#53615c]">
        ...
        <section className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <div className="relative aspect-square overflow-hidden rounded-lg border border-[#d8dfdc] bg-[#edf2ef]">
              <Image
          ...
          <div className="lg:pl-6">
            <div className="mb-4 inline-flex items-center gap-2 rounded-lg bg-[#edf2ef] px-3 py-2 text-sm font-bold text-[#063f34]">
              <BadgeCheck size={16} /> Verified artisan
            </div>
            <h1 className="max-w-2xl text-3xl font-black tracking-tight text-[#063f34] sm:text-4xl">
              The Earthbound Solstice Vase
            </h1>
            <p className="mt-3 text-base text-[#53615c]">
              by{" "}
            ...
            <div className="mt-5 flex flex-wrap items-center gap-4">
              <p className="text-3xl font-black text-[#1b211f]">$185.00</p>
              <p className="flex items-center gap-1 rounded-lg border border-[#d8dfdc] bg-white px-3 py-2 text-sm font-bold">
                <Star size={16} className="fill-[#c8651b] text-[#c8651b]" /> 4.8
                · 124 reviews
              </p>
            </div>

            <p className="mt-5 max-w-2xl text-base leading-7 text-[#53615c]">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={item}
                  className="rounded-lg border border-[#d8dfdc] bg-white px-3 py-2.5 text-sm font-bold text-[#25332e]"
                >
                  {item}
                </div>
              ))}
            ...
            <div className="mt-6 rounded-lg border border-[#d8dfdc] bg-white p-4">
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="flex h-11 w-36 items-center justify-between rounded-lg border border-[#d8dfdc] px-3">
                  <button
                ...
                <button className="h-11 flex-1 rounded-lg bg-[#f28a35] px-5 text-sm font-black text-white transition hover:bg-[#dc7624]">
                  Add to cart
                </button>
              </div>
              <button
                onClick={() => setSaved((value) => !value)}
                className="mt-3 flex h-10 w-full items-center justify-center gap-2 rounded-lg border border-[#063f34] text-sm font-black text-[#063f34] transition hover:bg-[#edf2ef]"
              >
        ...
        <section className="mt-12 grid gap-8 border-t border-[#d8dfdc] pt-10 lg:grid-cols-[300px_1fr]">
          <div>
            <p className="text-xs font-black text-[#9a4d10] uppercase">
              Reviews and ratings
            </p>
            <h2 className="mt-2 text-3xl font-black text-[#063f34]">
              Loved by collectors.
            </h2>
          ...
          <div className="space-y-5">
            {reviews.map((review) => (
              <article
                key={review.name}
                className="rounded-lg border border-[#d8dfdc] bg-white p-5"
              >
                ...
                <h3 className="mt-4 text-xl font-black text-[#1b211f]">
                  {review.title}
                </h3>
