    ...
    <div className="min-h-screen bg-[#fbfbf8]">
      ...
      <main className="mx-auto max-w-[1180px] px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-3xl font-black tracking-tight text-[#063f34]">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_340px]">
          <section className="space-y-5">
            <div className="rounded-lg border border-[#d8dfdc] bg-white p-5 lg:p-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  >
                    ...
                    <input className="h-10 w-full rounded-lg border border-[#d8dfdc] bg-[#fbfbf8] px-3 outline-none focus:border-[#063f34] focus:ring-4 focus:ring-[#063f34]/10" />
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="rounded-lg border border-[#d8dfdc] bg-white p-5 lg:p-6">
              ...
              <div className="rounded-lg border-2 border-[#063f34] bg-[#f6faf8] p-4">
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                  <input
                    className="h-10 rounded-lg border border-[#d8dfdc] bg-white px-3 outline-none sm:col-span-2"
                  ...
                  />
                  <input
                    className="h-10 rounded-lg border border-[#d8dfdc] bg-white px-3 outline-none"
                    placeholder="MM / YY"
                  />
                  <input
                    className="h-10 rounded-lg border border-[#d8dfdc] bg-white px-3 outline-none"
            ...
            <div className="rounded-lg border border-[#d8dfdc] bg-white p-5 lg:p-6">
              ...
              <div className="space-y-4">
                {reviewItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center gap-4 border-b border-[#d8dfdc] pb-4 last:border-0"
                  >
                    <div className="relative h-16 w-16 overflow-hidden rounded-lg bg-[#edf2ef]">
                      <Image
                        src={item.image}
                        alt=""
                        fill
          ...
          <aside className="h-fit rounded-lg border border-[#d8dfdc] bg-[#063f34] p-5 text-white lg:sticky lg:top-24">
            ...
            <div className="mt-6 border-t border-white/20 pt-6">
              ...
              <p className="mt-1 text-3xl font-black">$218.16</p>
            </div>
            <button className="mt-7 flex h-11 w-full items-center justify-center rounded-lg bg-[#f28a35] font-black text-white">
